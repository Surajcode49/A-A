    ...
    return (
        <div className="mx-[7vw] xl:-mt-20 xlllll:mt-20 mmd:my-[2vh] md:mt-[-15vh] sssm:my-[5vh]  relative">
            ...
            <div className=" absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center z-20">
                ...
                <h1 className="connect-text text-white xlllll:mx-5 xlllll:text-[4rem] roboto-black lg:text-[2.5rem] mmd:text-[2rem] mdm:text-[1.8rem] md:text-[1.7rem] sssm:text-[0.8rem] smmm:text-[0.85rem] ssmm:text-[0.85rem] ssm:text-[0.9rem] absolute xl:top-20 md:top-10 sssm:top-5 z-30">
                    READY TO CONNECT WITH OUR EXPERTS AND UNDERSTAND THE BENEFITS SAP WILL BRING TO YOUR BUSINESS?
                </h1>

                <h1 className="connect-text text-main3 xlllll:mx-5 roboto-black xlllll:text-[4rem] lg:text-[2.5rem] mmd:text-[2rem] mdm:text-[1.8rem] md:text-[1.7rem] sssm:text-[0.8rem] smmm:text-[0.85rem] ssmm:text-[0.85rem] ssm:text-[0.9rem] absolute xl:top-20 md:top-10 sssm:top-5 sssm:left-0.5 md:left-1 z-20">
                    READY TO CONNECT WITH OUR EXPERTS AND UNDERSTAND THE BENEFITS SAP WILL BRING TO YOUR BUSINESS?
                </h1>
