    ...
    <div>
      ...
      <div className="mx-10">
        <Image
          ...
          height={500}
          alt="arrow"
          className="arrow absolute xxxxxxl:scale-180 xlllll:scale-160 lxl:scale-125 xl:scale-100 lgg:scale-80 md:scale-50 sssm:scale-35 lgg:left-0 xlllll:left-[10vw] xxxxxxl:top-[55vh] xxxxxxl:left-[10vw] xlllll:top-[50vh] xlx:top-[52vh] lxl:left-[8vw] lxl:top-[52vh] xll:top-[45vh] xxl:top-[53vh] xl:top-[63vh] lgg:top-[45vh] mdd:top-[22vh] mdm:top-[19vh] md:top-[20vh] md:left-[-12vw] sssm:top-[17vh] smmm:top-[16vh] ssm:top-[14vh] sssm:left-[-23vw] xl:left-10"
        />
