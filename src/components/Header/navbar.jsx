  ...
  return (
    <header className="relative flex items-center justify-between w-full p-2 bg-white z-20">
      ...
      >
        ...
        <ul className="text-gray-500 text-lg flex flex-col lg:flex-row list-none space-y-4 lg:space-y-0 lg:space-x-8 p-6 lg:p-0 lg:ml-[-35vw]">
          ...
          <Image src="/Images/Header/Search_Icon.svg" width={20} height={20} alt="search"/>
        </ul>
      </nav>
