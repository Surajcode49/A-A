...
export default function About() {
    return (
        <div className="lg:mt-[50vh] xlllll:mt-[35vh] xl:mt-[40vh] sssm:mt-[2vh] justify-between items-center relative lg:mx-20 sssm:mx-10">
            <div className="w-1/3">
                <p className="text-black text-md font-semibold  xllll:text-xl xlllll:text-[2rem] roboto-light">ABOUT US</p>

                <h2 className="text-xl xllll:text-3xl  xlllll:text-[2.5rem] xlllll:mt-5 font-bold roboto-black">
            ...
            <div className="flex lg:scale-100 xlll:scale-110 xllll:scale-125 sssm:scale-75 md:scale-90 lg:mt-[-15vh md:mt-[-10vh] sssm:mt-[-13vh]">
                <div className="bg-accent/80 md:scale-80 lg:scale-100 lg:max-w-[600px] sssm:max-w-screen xlllll:max-w-[850px] xllll:max-w-[800px] xll:max-w-[650px] mmd:max-w-[520px] md:min-w-[400px] md:max-w-[500px] lg:px-[8vw] md:px-[6vw] sssm:px-[20vw] ssm:min-w-[620px] py-2 absolute top-[20vh] xl:ml-[-6.5vw] lg:ml-[-9vw] xlll:ml-[-2vw] xllll:ml-[2vw] mmd:ml-[-16vw] md:ml-[-18vw] sssm:ml-[-30vw]">
                    <p className="text-white md:text-sm xllll:text-lg sssm:xs p-3 sssm:my-2 leading-6 text-justify">
                    ...
                    <button className="bg-main3 rounded-tr-xl xlllll:max-w-[10vw] lg:ml-[1vw] md:ml-[2vw] rounded-tl-xl rounded-bl-xl lg:w-[15vw] md:w-[30vw] sssm:w-[50vw] flex mb-4 h-10 p-2 mx-20 text-white justify-center text-center font-semibold">
                        Read More
                ...
                <div className="bg-gray-100 lg:min-w-[500px] xlllll:max-w-[620px] xlllll:px-[4.5vw] xlllll:left-[55vw] xlllll:top-[15vh] sssm:scale-85 xllll:scale-115 md:scale-70 lg:scale-100 md:max-w-full sssm:max-w-[570px] ssm:max-w-[700px] ssmm:min-w-[610px] lg:px-[6vw] md:px-[12vw] md:pr-[12.5vw] sssm:px-[22vw] ssmm:px-[26vw] absolute lg:top-[5vh] md:top-[10vh] xllll:left-[58.4vw] lg:left-[50vw] md:left-[36vw] sssm:top-[110vh] smmm:top-[110vh] ssmm:top-[115vh] ssm:top-[98vh] sssm:left-[-40vw] rounded-lg">
                    <h1 className="text-accent p-3 font-semibold text-center mt-[5vh]">DO YOU SHARE OUR VALUES?</h1>
                    <p className="text-gray-500 lg:text-[0.9rem]  p-3 leading-6 text-center">
                    ...
                    <div className="flex p-1 mx-6 sssm:px-8">
                        <div className="bg-white lg:w-[12vw] md:w-[20vw] sssm:w-[40vw] items-center justify-center p-3 mx-2 rounded-md rounded-br-none border-b-4 border-main3 border-r-4 relative cursor-pointer">
            ...
            <div className="lg:ml-[2vw] ssm:mt-[-5vh] ssm:ml-[-25vw] xlllll:ml-[9vw] md:ml-[-2vw] mdd:ml-[-4vw] mdm:ml-[-3vw] mdd:mt-[15vh] xllll:ml-[12vw] xllll:mt-[24vh] sssm:ml-[-30vw] xll:scale-125 xllll:scale-160 sssm:scale-140 md:scale-90 lg:scale-80 xl:scale-100 mmd:scale-100 md:mt-[14vh]">
                <div className="w-2/3 flex items-center max-w-[210px] mdd:scale-90 mmd:scale-80 lg:scale-125 mdm:scale-90 md:scale-75 sssm:scale-90 justify-center lg:mt-[15vh] md:mt-[12vh] ssm:mt-[58vh] ssmm:mt-[65vh] sssm:mt-[62vh] relative" style={{marginLeft: '35vw'}}>
                    <div className="bg-main3 w-full xlllll:h-[13vh] xl:h-[24vh] mdm:h-[11.3vh] lg:h-[21vh] md:h-[15vh] sssm:h-[18vh] mdd:h-[13vh] ssmm:h-[18.5vh] ssm:h-[16vh] p-4 lg:ml-[0.5vw] sssm:ml-[1.5vw] relative overflow-visible rounded-t-xl rounded-bl-xl about"></div>
